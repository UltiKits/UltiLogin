...
import com.ultikits.plugins.login.i18n.UltiLoginLanguageCatalogueTest.Catalogue;
 ...
 * ({@link UltiLoginLanguageCatalogueTest#loadModuleCatalogues()}: the framework's own {@link Language},
...
public final class CatalogueText {
    ...
    public static Map<String, String> entries(String code) {
        try {
            for (Catalogue c : UltiLoginLanguageCatalogueTest.loadModuleCatalogues()) {
